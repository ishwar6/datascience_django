...
from states.models import Chapter
...
class UserState(models.Model):
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, blank=True, null=True)
    active_part = models.IntegerField(
        default=0, help_text='It is 0 for entering detail stage, 1 for assessment, 2 for report and 3 to begin learning and ending of assessment')
