...
class CurrentQuestion(models.Model):
	...
	question        = models.ForeignKey(AssessmentQuestion, on_delete = models.DO_NOTHING, blank = True, null = True, help_text= ' Gives current question only if chapter is running currently ')
